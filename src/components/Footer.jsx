  ...
  return (
    <>
      ...
      <div className="bg-[#0060df] p-10 w-full mt-5">
        <div className="max-w-screen-xl mx-auto flex flex-wrap gap-8 justify-between items-start">
          ...
          <div className="flex-1 min-w-[300px]">
            ...
            >
              ...
              <input
                ...
                className="w-full p-2 rounded-md text-sm text-gray-700 bg-white border border-gray-300 focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
              />
              <input
                type="email"
                value={email}
              ...
              <button
                type="submit"
                className="w-full h-10 text-white bg-teal-500 rounded-md hover:bg-teal-600 transition-all"
              >
                Submit
              </button>
            </form>
