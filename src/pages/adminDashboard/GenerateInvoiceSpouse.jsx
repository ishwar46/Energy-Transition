...
const GenerateInvoiceSpouse = () => {
  ...
  const handleGenerateInvoice = async () => {
    ...
    const totalAmount = accompanyFee;
    const invoiceNumber = generateInvoiceNumber();

    const newInvoice = {
      participantName: participantName || "N/A",
      accompanyPersonName: accompanyPersonName || "N/A",
  ...
  return (
    <>
      <div className="text-2xl font-bold text-start mb-4 text-black pt-5">
        Generate Invoice for Accompany Person
      </div>
      <div className="mt-5 p-5 border border-gray-200 rounded-md bg-white shadow-sm">
        ...
        <div className="mb-5">
          ...
          <input
            ...
            onChange={(e) => setAccompanyPersonName(e.target.value)}
        ...
        <>
          ...
          >
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-900">
                <strong>Accompany Person:</strong> {invoice.accompanyPersonName}
              </p>
              <p className="text-gray-900">
...
export default GenerateInvoiceSpouse;
