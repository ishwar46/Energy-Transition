                        ...
                        <div className="text-left">
                          ...
                          {message.author1.author1image && (
                            <img
                              ...
                              src={
                                message.author1.author1image
                                  ? // ? `https://energy-transition-api-eg0r.onrender.com/${message.author1.author1image}`
                                    `https://energy-transition-api-eg0r.onrender.com/${message.author1.author1image}`
                        ...
                        <div className="text-left">
                          ...
                          {message.author2.author2image && (
                            <img
                              ...
                              src={
                                message.author2.author2image
                                  ? `https://energy-transition-api-eg0r.onrender.com/${message.author2.author2image}`
                                  : "https://via.placeholder.com/100"
                              }
            ...
            <div className="relative w-1/2 h-1/2 my-6 mx-auto max-w-3xl  ">
              <div className="  border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  ...
                  <img
                    // src={`https://energy-transition-api-eg0r.onrender.com/${selectedMessage.author2.author2image}`}
                    src={
                      selectedMessage.author2.author2image
                        ? `https://energy-transition-api-eg0r.onrender.com/${selectedMessage.author2.author2image}`
                        : "https://via.placeholder.com/100"
                    }
                    style={{ width: "80px" }}
                    alt=""
                  />
                  <img
                    // src={`https://energy-transition-api-eg0r.onrender.com/${selectedMessage.author1.author1image}`}
                    src={
                      selectedMessage.author1.author1image
                        ? // ? `https://energy-transition-api-eg0r.onrender.com/${selectedMessage.author1.author1image}`
                          `https://energy-transition-api-eg0r.onrender.com/${selectedMessage.author1.author1image}`
                        : "https://via.placeholder.com/100"
                    }
                    style={{ width: "80px" }}
