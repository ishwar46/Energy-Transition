...
const AddSpeaker = () => {
  ...
  const handleEdit = (speaker) => {
    ...
    let imageUrls = "";
    if (speaker?.image) {
      imageUrls = `https://energy-transition-api-eg0r.onrender.com/${speaker?.image}`;
      // imageUrls = `https://energy-transition-api-eg0r.onrender.com/${speaker?.image}`;
    }
  ...
  const handleAddtoSpeaker = (user) => {
    ...
    if (user?.profilePicture?.fileName) {
      // imageUrls = `https://energy-transition-api-eg0r.onrender.com/${user.profilePicture.fileName}`;
            ...
            >
              <div className="flex items-center">
                <img
                  src={
                    speaker.image
                      ? `https://energy-transition-api-eg0r.onrender.com/${speaker.image}`
