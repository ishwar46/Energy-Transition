...
const AddSpeaker = () => {
  ...
  const handleEdit = (speaker) => {
    ...
    let imageUrls = "";
    if (speaker?.image) {
      imageUrls = `https://api-energy.onrender.com/${speaker?.image}`;
      // imageUrls = `https://api-energy.onrender.com/${speaker?.image}`;
    }
  ...
  const handleAddtoSpeaker = (user) => {
    ...
    if (user?.profilePicture?.fileName) {
      // imageUrls = `https://api-energy.onrender.com/${user.profilePicture.fileName}`;
            ...
            >
              <div className="flex items-center">
                <img
                  src={
                    speaker.image
                      ? `https://api-energy.onrender.com/${speaker.image}`
